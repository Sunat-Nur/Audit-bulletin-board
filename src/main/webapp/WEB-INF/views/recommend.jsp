			...
			<table class="table table-bordered">
				<tr>
					...
					<td><input type="text" class="form-control" id="title"
						name="title" value=" [RE] ${board.boardTitle}" readonly></td>
				</tr>
				<tr>
					<th>작성자</th>
					<td><input type="text" class="form-control" id="writer"
						name="writer" value="${comment.commentWriter}" readonly></td>
				</tr>
				<tr>
					<th>콘텐트</th>
					<td><textarea class="form-control" id="content" name="content"
							rows="5" required>${comment.commentContents}</textarea></td>
				</tr>
				<tr>
